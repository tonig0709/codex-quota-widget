...
precondition(ParticleMotion.unitPhase(-0.25) == 0.75)
precondition(ParticleMotion.unitPhase(1.25) == 0.25)
precondition(ParticleMotion.hoverInfluence(distance: 20, nearestEdgeDistance: 20) == 1)
precondition(ParticleMotion.hoverInfluence(distance: 90, nearestEdgeDistance: 20) == 0)
