...
**Latest release: [v0.6.2](https://github.com/tonig0709/codex-quota-widget/releases/tag/v0.6.2)** ·
[Download the macOS DMG](https://github.com/tonig0709/codex-quota-widget/releases/download/v0.6.2/Codex-Quota-v0.6.2-macOS.dmg)
...
1. Download [Codex-Quota-v0.6.2-macOS.dmg](https://github.com/tonig0709/codex-quota-widget/releases/download/v0.6.2/Codex-Quota-v0.6.2-macOS.dmg).
