...
**Latest release: [v0.5.4](https://github.com/tonig0709/codex-quota-widget/releases/tag/v0.5.4)** ·
[Download the macOS DMG](https://github.com/tonig0709/codex-quota-widget/releases/download/v0.5.4/Codex-Quota-v0.5.4-macOS.dmg)
...
1. Download [Codex-Quota-v0.5.4-macOS.dmg](https://github.com/tonig0709/codex-quota-widget/releases/download/v0.5.4/Codex-Quota-v0.5.4-macOS.dmg).
