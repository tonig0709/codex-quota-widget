...
When upgrading from v0.3.1 or earlier, remove the old desktop widget once and
add it again. v0.3.2 exposes the small and large layouts as separate gallery
entries so macOS always lists both sizes.
